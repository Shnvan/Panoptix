...
- [x] Staging healthcheck workflow hardened to send Cloudflare Access service-token headers, avoid raw response bodies in `$GITHUB_OUTPUT`, and file deduped GitHub issues through the REST API without `actions/github-script`
