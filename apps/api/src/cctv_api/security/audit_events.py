...
_r("auth.login.denied.user_disabled", S.high, C.authentication, O.denied)
...
_r("admin.user.invited", S.high, C.authorization, O.success)
_r("admin.user.invite.denied.user_disabled", S.high, C.authorization, O.denied)
_r("visitor.access_request.created", S.medium, C.authorization, O.success)
_r("admin.access_request.approved", S.high, C.authorization, O.success)
_r("admin.access_request.rejected", S.medium, C.authorization, O.denied)
_r("admin.access_request.approve.denied.user_disabled", S.high, C.authorization, O.denied)
...
_r("gateway.discovery.reported", S.low, C.system, O.success)
_r("gateway.discovery.denied.gateway_mismatch", S.medium, C.system, O.denied)
_r("gateway.discovery.denied.disabled", S.high, C.system, O.denied)
