      ...
      <div className={`border rounded-lg p-5 ${d ? 'bg-slate-900/70 border-slate-700/50' : 'bg-white border-slate-200'}`}>
        <div className="flex items-center justify-between gap-3 mb-4">
          ...
          <button
            ...
            className={`inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm disabled:opacity-50 ${d ? 'bg-slate-800 text-slate-300 hover:bg-slate-700' : 'bg-slate-100 text-slate-700 hover:bg-slate-200'}`}
          >
